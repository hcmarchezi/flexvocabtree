...
def clustering(data: np.ndarray, k: int, dissimilarity: Callable[[np.ndarray, np.ndarray], float], 
            average: Callable[[np.ndarray], np.ndarray], stop_criteria: float = 0.1, 
            attempts: int = 3) -> Tuple[np.ndarray, Dict[int, List[int]]]:
...
def _find_nearest_centroid(data: np.ndarray, centroids: np.ndarray, 
                           dissimilarity: Callable[[np.ndarray, np.ndarray], float]) -> Dict[int, List[int]]:
    centroid_labels: Dict[int, List[int]] = {}
...
def _calculate_new_centroids(data: np.ndarray, centroid_labels: Dict[int, List[int]], 
                            k: int, average: Callable[[np.ndarray], np.ndarray], 
                            original_centroids: np.ndarray) -> np.ndarray:
